...
import com.example.mapfeature.directionhelpers.FetchURL;
import com.example.mapfeature.directionhelpers.TaskLoadedCallback;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //new FetchURL(MapActivity.this).execute(getUrl(place1.getPosition(), place3.getPosition(), "driving"), "driving");
            }
        });
...
//        place3.icon(BitmapDescriptorFactory.fromResource(R.drawable.tescoreal_round));
    ...
    private String getUrl(LatLng origin, LatLng dest, String directionMode) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&key=" + getString(R.string.MAPVIEW_BUNDLE_KEY);
        return url;
    }
...
//            moveCamera(new LatLng(51.532838,-0.472856), DEFAULT_ZOOM,
...
//                            moveCamera(new LatLng(51.532838,-0.472856),
//                                    DEFAULT_ZOOM,
//                                    "My Location");
